...
// SW Dshot defines
//-----------------------------------------------------------------------------------------------------------------------------------------
#define DSHOT_PIN3 GPIO_Pin_0
#define DSHOT_PIN3_NUM 0
#define DSHOT_PIN3_GPIO GPIOB

#define DSHOT_PIN4 GPIO_Pin_1
#define DSHOT_PIN4_NUM 1
#define DSHOT_PIN4_GPIO GPIOB

#define DSHOT_PIN1 GPIO_Pin_4
#define DSHOT_PIN1_NUM 4
#define DSHOT_PIN1_GPIO GPIOB

#define DSHOT_PIN2 GPIO_Pin_5
#define DSHOT_PIN2_NUM 5
#define DSHOT_PIN2_GPIO GPIOB
...
void __attribute__((optimize("O1"))) SW_DSHOT_TIM_IRQHandler(void){
	...
	if(DshotBitStep == 0){ // rising edge
		...
		SW_DSHOT_TIM->ARR = Dshot_Till0_Time; // set the next interrupt time to 50% period
		DshotBitStep = 1;
